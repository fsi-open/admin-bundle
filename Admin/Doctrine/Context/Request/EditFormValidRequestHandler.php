...
class EditFormValidRequestHandler implements HandlerInterface
{
    /**
    ...
    public function handleRequest(AdminEvent $event, Request $request)
    {
        ...
        if ($request->getMethod() == 'POST') {
            if ($event->getForm()->isValid()) {
                $this->eventDispatcher->dispatch(CRUDEvents::CRUD_EDIT_ENTITY_PRE_SAVE, $event);
                ...
                $this->eventDispatcher->dispatch(CRUDEvents::CRUD_EDIT_ENTITY_POST_SAVE, $event);
        ...
        $this->eventDispatcher->dispatch(CRUDEvents::CRUD_EDIT_RESPONSE_PRE_RENDER, $event);
        if ($event->hasResponse()) {
            return $event->getResponse();
        }
    }
