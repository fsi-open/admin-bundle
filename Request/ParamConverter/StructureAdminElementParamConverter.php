 ...
 */
class StructureAdminElementParamConverter implements ParamConverterInterface
{
    /**
    ...
    {
        return "FSi\Bundle\AdminBundle\Structure\AdminElementInterface" === $configuration->getClass();
    }
}