 ...
 */
class StructureElementParamConverter implements ParamConverterInterface
{
    /**
    ...
    {
        return "FSi\Bundle\AdminBundle\Structure\ElementInterface" === $configuration->getClass();
    }
}