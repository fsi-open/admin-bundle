...
class DeleteContextBuilderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('FSi\Bundle\AdminBundle\Admin\Context\Doctrine\DeleteContextBuilder');
    }
    ...
    function it_build_context(CRUDElement $element, DoctrineDataIndexer $indexer)
    {
        ...
        $this->buildContext($element)->shouldReturnAnInstanceOf('FSi\Bundle\AdminBundle\Admin\Context\Doctrine\DeleteContext');
    }
}
