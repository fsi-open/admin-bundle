...
class DeleteFormSubmitHandlerSpec extends ObjectBehavior
{
    ...
    function it_throw_exception_for_non_form_event(ListEvent $listEvent, Request $request)
    {
        $this->shouldThrow(
                new RequestHandlerException(
                    "FSi\\Bundle\\AdminBundle\\Admin\\Doctrine\\Context\\Request\\DeleteFormSubmitHandler require FormEvent"
                )
