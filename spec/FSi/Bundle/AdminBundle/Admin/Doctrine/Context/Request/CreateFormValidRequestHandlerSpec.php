...
class CreateFormValidRequestHandlerSpec extends ObjectBehavior
{
    ...
    function it_throw_exception_for_non_list_event(ListEvent $listEvent, Request $request)
    {
        $this->shouldThrow(
                new RequestHandlerException(
                    "FSi\\Bundle\\AdminBundle\\Admin\\Doctrine\\Context\\Request\\CreateFormValidRequestHandler require FormEvent"
                )
