...
class CreateFormSubmitHandlerSpec extends ObjectBehavior
{
    ...
    function it_throw_exception_for_non_list_event(ListEvent $listEvent, Request $request)
    {
        $this->shouldThrow(
                new RequestHandlerException(
                    "FSi\\Bundle\\AdminBundle\\Doctrine\\Admin\\Context\\Request\\CreateFormSubmitHandler require FormEvent"
                )
