...
class FormValidRequestHandlerSpec extends ObjectBehavior
{
    ...
    function it_throw_exception_for_non_list_event(ListEvent $listEvent, Request $request)
    {
        $this->shouldThrow(
                new RequestHandlerException(
                    "FSi\\Bundle\\AdminBundle\\Doctrine\\Admin\\Context\\Create\\Request\\FormValidRequestHandler require FormEvent"
                )
    ...
    function it_do_nothing_on_non_POST_request(
        ...
        $eventDispatcher->dispatch(CRUDEvents::CRUD_CREATE_RESPONSE_PRE_RENDER, $event)
            ->shouldBeCalled();
    ...
    function it_handle_POST_request(
        ...
        $eventDispatcher->dispatch(CRUDEvents::CRUD_CREATE_ENTITY_PRE_SAVE, $event)
            ->shouldBeCalled();
        ...
        $eventDispatcher->dispatch(CRUDEvents::CRUD_CREATE_ENTITY_POST_SAVE, $event)
            ->shouldBeCalled();
