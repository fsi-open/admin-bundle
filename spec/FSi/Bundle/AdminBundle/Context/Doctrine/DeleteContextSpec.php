...
class DeleteContextSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('FSi\Bundle\AdminBundle\Context\Doctrine\DeleteContext');
    }
        ...
        ParameterBag $bag, CRUDElement $element, Router $router)
    {
        ...
        $element->delete(Argument::type('spec\FSi\Bundle\AdminBundle\Context\Doctrine\Entity'))->shouldBeCalledTimes(2);
