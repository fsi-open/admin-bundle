...
class ListContextBuilderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('FSi\Bundle\AdminBundle\Context\Doctrine\ListContextBuilder');
    }
    ...
    {
        $this->buildContext($element)->shouldReturnAnInstanceOf('FSi\Bundle\AdminBundle\Context\Doctrine\ListContext');
    }
}
