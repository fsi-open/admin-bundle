...
class EditContextBuilderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('FSi\Bundle\AdminBundle\Context\Doctrine\EditContextBuilder');
    }
    ...
    function it_build_context(CRUDElement $element, DoctrineDataIndexer $indexer)
    {
        ...
        $this->buildContext($element)->shouldReturnAnInstanceOf('FSi\Bundle\AdminBundle\Context\Doctrine\EditContext');
    }
}
